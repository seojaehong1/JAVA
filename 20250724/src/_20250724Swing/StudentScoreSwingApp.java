...
class MyFrame1 extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == jb1) {
			...
			JOptionPane.showMessageDialog(this, "학생수입력완료");
		} else if (e.getSource() == jb2) {
		    if (i < scores.length) {
		        scores[i] = Integer.parseInt(jt2.getText());
		        JOptionPane.showMessageDialog(this, "scores[" + i + "] = " + scores[i]);
		        i++;
		        jt2.setText("");  
		    } else {
		        JOptionPane.showMessageDialog(this, "점수 입력 불가능");
		    }
		} else if(e.getSource() == jb3) {
			for(int j=0; j<scores.length; j++ ) {
				JOptionPane.showMessageDialog(this, scores[j]+"\n");
			}
			...
			JOptionPane.showMessageDialog(this, "최고점수"+k+"\t평균점수"+a/scores.length);
		}
...
public class StudentScoreSwingApp {
