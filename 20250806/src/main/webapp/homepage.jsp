...
<ul>
		  ...
		  <li><a href="hregMemForm.jsp">회원가입</a></li>
		  <li><a href="showMem.jsp">로그인</a></li>
		  <li><a href="showMem.jsp">내정보수정</a></li>
		  <li><a href="insertForm.jsp">메모</a></li>
		  <li><a href="list.jsp">메모목록</a></li>
		  <li class="dropdown">
